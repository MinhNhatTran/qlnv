...
<html lang="en">
    ...
    <body id="page-top" style="background-image: url('assets/img/header-bg.jpg');">
            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarResponsive">
                    <ul class="navbar-nav text-uppercase ml-auto">
                        ...
                        <li class="nav-item"><a class="nav-link js-scroll-trigger" href="elogin.php">LOG IN</a></li>
                    </ul>
                </div>
            </div>
        </nav>
		...
		<p style="font-family: Montserrat ; text-align: center; font-size: 40px;color : white; padding-top:200px">Group Members</p>

		<div style="float: left; width: 33%">
			
			<p style="text-align: center;"><img src="process/images/no.jpg" alt="Avatar" style="width:250px"></p>
			<h2 style="text-align: center; font-family:Montserrat ;color : yellow">Phạm Hải Vũ</h2>
		...
		<div style="float: left; width: 33%">
			...
			<h2 style="text-align: center; font-family:Montserrat;color : yellow ">Trần Minh Nhật</h2>
		...
		<div style="float: left; width: 33%">
			...
			<p style="text-align: center;"><img src="process/images/no.jpg" alt="Avatar" style="width:250px"></p>
			<h2 style="text-align: center; font-family:Montserrat ;color : yellow">Nguyễn Đức Hoằng</h2>
